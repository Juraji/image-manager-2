...
public class ManagerTaskTest extends IMTest {
    ...
    public void updateTaskDescription() throws Exception {
        ...
        assertEquals("Test task", task.getTaskDescription().getValue());

        task.call();

        assertEquals("This is a new description", task.getTaskDescription().getValue());
    }
    ...
    public void getTaskProgress() throws Exception {
        ...
        assertEquals(0.0, task.getTaskProgress().getValue(), 0.1);

        task.call();

        assertEquals(0.5, task.getTaskProgress().getValue(), 0.1);
    }
    ...
    public void updateWorkDone() throws Exception {
        ...
        assertEquals(6, task.getWorkTodo());
        assertEquals(0.83, task.getTaskProgress().getValue(), 0.01);
    }
    ...
    public void incrementWorkDone() throws Exception {
        ...
        assertEquals(6, task.getWorkTodo());
        assertEquals(0.16, task.getTaskProgress().getValue(), 0.01);
    }
}
